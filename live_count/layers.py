...
class LogisticRegression(object):
    ...
    def errors(self, y):
        ...
        #self.y_pred = T.argmax(self.p_y_given_x_printed, axis=1)

        #self.y_pred_printed = theano.printing.Print('y_pred is:')(self.y_pred)
...
class HiddenLayer(object):
    def __init__(self, rng, input, n_in, n_out, W=None, b=None,
        ...
        #        should use 4 trimes larger initial weights for sigmoid
        #        compared to tanh
